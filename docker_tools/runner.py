...
def action_ionic_serve():
    print(action_ionic_serve)
    subprocess.run(['ionic', 'serve'], shell=True, stdin=True, capture_output=True)
...
def action_generate_rsa_key():
    print ('Generiere einen RSA Key für Android ...')
    ...
    subprocess.run([
        ...
        '-keysize 2048', 
        '-validity 10000'
        ], shell=True, stdin=True, capture_output=True)
